...
void JGB37_Motor_SetDuty(JGB37_ValueStructure* jgb37)
{
    ...
    __HAL_TIM_SetCompare(PWMA_TIM_HANDLE,PWMA_TIM_CHANNEL,(uint16_t)(MOTOR_TIM_AUTORELOAD*((*jgb37).A_pwm_duty)/100));
    __HAL_TIM_SetCompare(PWMB_TIM_HANDLE,PWMB_TIM_CHANNEL,(uint16_t)(MOTOR_TIM_AUTORELOAD*((*jgb37).B_pwm_duty)/100));
}
