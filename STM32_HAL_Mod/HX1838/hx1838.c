...
/************************************************************************************************************************************** */
void HX1838_TIM_Overflow(HX1838_ValueStructure* hx1838, TIM_HandleTypeDef *htim)
{
...
void HX1838_TIM_InputCapture(HX1838_ValueStructure* hx1838, TIM_HandleTypeDef *htim)
{
    if(HX1838_TIM_X == htim->Instance)
	{
