...
}HX1838_ValueStructure;
/********************************************************************************* */
void HX1838_Start(void);
void HX1838_Stop(void);
void HX1838_Decode(HX1838_ValueStructure* hx1838);
void HX1838_TIM_Overflow(HX1838_ValueStructure* hx1838, TIM_HandleTypeDef *htim); //在溢出中断回调中使用
void HX1838_TIM_InputCapture(HX1838_ValueStructure* hx1838, TIM_HandleTypeDef *htim); //在捕获中断回调中使用
