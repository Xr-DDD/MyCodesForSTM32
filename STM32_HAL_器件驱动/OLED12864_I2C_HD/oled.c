...
{
	HAL_I2C_Mem_Write(OLED_I2C_HANDLE,DEV_ADDR,CMD_ADDR,I2C_MEMADD_SIZE_8BIT,&cmd,1,I2C_TIME_OUT);
}
...
{
	HAL_I2C_Mem_Write(OLED_I2C_HANDLE,DEV_ADDR,CMD_ADDR,I2C_MEMADD_SIZE_8BIT,cmd,len,I2C_TIME_OUT);
}
...
{
	HAL_I2C_Mem_Write(OLED_I2C_HANDLE,DEV_ADDR,DAT_ADDR,I2C_MEMADD_SIZE_8BIT,&data,1,I2C_TIME_OUT);
}
...
{
	HAL_I2C_Mem_Write(OLED_I2C_HANDLE,DEV_ADDR,DAT_ADDR,I2C_MEMADD_SIZE_8BIT,data,len,I2C_TIME_OUT);
}
